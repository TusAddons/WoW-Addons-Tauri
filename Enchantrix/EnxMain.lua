--[[
	...
	Revision: $Id: EnxMain.lua 5735 2018-02-01 02:51:17Z ccox $
...
Enchantrix_RegisterRevision("$URL: http://svn.norganna.org/auctioneer/trunk/Enchantrix/EnxMain.lua $", "$Rev: 5735 $")
...
function addonLoaded(hookArgs, event, addOnName)
	...
	Enchantrix.Revision = Enchantrix.Util.GetRevision("$Revision: 5735 $")
