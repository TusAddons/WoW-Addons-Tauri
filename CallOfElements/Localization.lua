...
COESTR_TOTEMICCALL = "Totemic Call";
COESTR_RANKGSUB = "( [IVX]+)$";
...
COE_OptionScalingTimers = "Timers Scaling";
...
COE_OptionDisableTTCombat = "If you want tooltips to be disabled while in combat";
}
...
BINDING_NAME_COEDROPSET = "Open sub-menu for the active totem set";
...
BINDING_NAME_TOTEMEARTH6 = "Earth Totem #6";
BINDING_NAME_TOTEMEARTH7 = "Earth Totem #7";
BINDING_NAME_TOTEMEARTH8 = "Earth Totem #8";
BINDING_NAME_TOTEMEARTH9 = "Earth Totem #9";
...
BINDING_NAME_TOTEMFIRE6 = "Fire Totem #6";
BINDING_NAME_TOTEMFIRE7 = "Fire Totem #7";
BINDING_NAME_TOTEMFIRE8 = "Fire Totem #8";
BINDING_NAME_TOTEMFIRE9 = "Fire Totem #9";
...
BINDING_NAME_TOTEMWATER7 = "Water Totem #7";
BINDING_NAME_TOTEMWATER8 = "Water Totem #8";
BINDING_NAME_TOTEMWATER9 = "Water Totem #9";
...
BINDING_NAME_TOTEMAIR8 = "Air Totem #8";
BINDING_NAME_TOTEMAIR9 = "Air Totem #9";
