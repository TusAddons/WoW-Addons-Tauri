...
newRing = CreateFrame("FRAME") do
	-- Only ever shown/parented reactively via btnNewRing's OnClick ->
	-- conf.overlay(); without an explicit initial Hide() it rendered as a
	-- blank 400x110 frame as soon as the addon loaded.
	newRing:Hide()
