--[[
	...
	Revision: $Id: SearcherConverter.lua 5731 2018-01-18 01:49:33Z ccox $
...
AucAdvanced.RegisterRevision("$URL: http://svn.norganna.org/auctioneer/trunk/Auc-Util-SearchUI/SearcherConverter.lua $", "$Rev: 5731 $")
