--[[
	...
	Revision: $Id: CoreMain.lua 5725 2017-09-21 19:51:13Z brykrys $
...
AucAdvanced.RegisterRevision("$URL: http://svn.norganna.org/auctioneer/trunk/Auc-Advanced/CoreMain.lua $", "$Rev: 5725 $")
