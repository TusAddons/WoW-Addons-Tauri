--[[
	...
	Revision: $Id: SelectBox.lua 434 2017-09-23 12:08:04Z brykrys $
...
LibStub("LibRevision"):Set("$URL: http://svn.norganna.org/libs/trunk/Configator/SelectBox.lua $","$Rev: 434 $","5.1.DEV.", 'auctioneer', 'libs')
