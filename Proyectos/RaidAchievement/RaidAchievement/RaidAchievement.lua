...
bigmenuchatlistea[#bigmenuchatlistea+1] = psfchatadd[i]
end
end
end
...
if #psfchatadd>0 then
for i=1,#psfchatadd do
lowmenuchatlistea[#lowmenuchatlistea+1] = psfchatadd[i]
end
end
end
...
table.wipe(racanannouncetable)
racanannouncetable[#racanannouncetable+1] = ranamemsgsend
end

if raannouncewait then
raannouncewait[#raannouncewait+1] = chtorep
end
