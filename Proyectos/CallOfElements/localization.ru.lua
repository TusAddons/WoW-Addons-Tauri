--[[ ----------------------------------------------------------------
			Русский (локализация Аспарагус - Ясеневый лес)
-------------------------------------------------------------------]]
...
COESTR_HEALLOWERRANK = "Недостаточно манны. Использую ранк %d";
COESTR_HEALOOM = "Недостаточно манны!";
-- String patterns
-- ----------------
...
COESTR_TOTEMICCALL = "Тотемный клич";
COESTR_RANKGSUB = "( [IVX]+)$";
-- Totem Advisor
-- --------------
...
COESTR_TOTEMDISEASE = "Тотем снимающий болезни";
...
"Сон", "Запугивание", "Ментальный крик", "Контроль над разумом", "Раскатистый рев", "Страх",
	"Устрашающий крик", "Паника", "Ужасающий визг", "Соблазнение",
...
COE_OptionScalingTimers = "Масштаб таймера";
...
BINDING_NAME_COEDROPSET = "Открыть подменю для активного тотем сета";
...
BINDING_NAME_TOTEMEARTH6 = "Тотем земли #6";
BINDING_NAME_TOTEMEARTH7 = "Тотем земли #7";
BINDING_NAME_TOTEMEARTH8 = "Тотем земли #8";
BINDING_NAME_TOTEMEARTH9 = "Тотем земли #9";
...
BINDING_NAME_TOTEMFIRE6 = "Тотем огня #6";
BINDING_NAME_TOTEMFIRE7 = "Тотем огня #7";
BINDING_NAME_TOTEMFIRE8 = "Тотем огня #8";
BINDING_NAME_TOTEMFIRE9 = "Тотем огня #9";
...
BINDING_NAME_TOTEMWATER7 = "Тотем воды #7";
BINDING_NAME_TOTEMWATER8 = "Тотем воды #8";
BINDING_NAME_TOTEMWATER9 = "Тотем воды #9";
...
BINDING_NAME_TOTEMAIR8 = "Тотем воздуха #8";
BINDING_NAME_TOTEMAIR9 = "Тотем воздуха #9";
-- Key modifiers
-- --------------
COEMODIFIER_ALT = "ALT";
