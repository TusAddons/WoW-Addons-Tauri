...
L["Use epics to fill XP missions"] = true
L["If an XP mission lacks non-epic followers to fill all slots, use epic followers for remaining slots"] = true
...
L["Minimum XP missions level"] = true
L["Ignore XP missions under this level"] = true
L["Minimum Gold Value"] = true
L["Gold missions wich returns less than this amount are ignored"] = true
L["Auto Logout"] = true
L["Automatically logout after sending missions"] = true
L["No tooltips"] = true
L["Totally removes mission tooltips"] = true
L["Ignore resource missions (>6000)"] = true
L["Ignore resource missions if you already have more than 6000 resources"] = true
...
if (L) then
L["%s |4follower:followers; with %s"] = "%s |4seguidor:seguidores; con %s"
L["(Ignores low bias ones)"] = "(Ignora los de bajo sesgo)"
L["Add %1$d levels to %2$s"] = "Añadir %1$d niveles a %2$s"
L["Adds a list of other useful followers to tooltip"] = "Añade una lista de otros seguidores útiles en el tooltip"
L["Affects only little screen mode, hiding the per follower mission list if not checked"] = "Afecta solo al modo de pantalla reducida, ocultando la lista de misiones por seguidor si no está activado"
L["Allowed Rewards"] = "Recompensas Permitidas"
L["Allows a lower success percentage for resource missions. Use /gac gui to change percentage. Default is 80%"] = "Permite un porcentaje menor de éxito para misiones de recursos. Usa /gac gui para cambiarlo. Por defecto es 80%"
L["Applied when 'maximize result' is enabled. Default is 80%"] = "Se aplica al activar 'maximizar resultado'. Por defecto es 80%"
L["Applies the best armor set"] = "Aplica el mejor conjunto de armadura"
L["Applies the best armor upgrade"] = "Aplica la mejor mejora de armadura"
L["Applies the best weapon set"] = "Aplica el mejor conjunto de arma"
L["Applies the best weapon upgrade"] = "Aplica la mejor mejora de arma"
L["Archaelogy"] = "Arqueología"
L["Big screen"] = "Pantalla grande"
L["Blacklisted"] = "En lista negra"
L["Blacklisted missions are ignored in Mission Control"] = "Las misiones en lista negra son ignoradas en el Control de Misiones"
L["Building Final report"] = "Generando informe final"
L["Capped %1$s. Spend at least %2$d of them"] = "%1$s al máximo. Gasta al menos %2$d"
L["Complete all missions without confirmation"] = "Completar todas las misiones sin confirmación"
L["Consider again"] = "Considerar de nuevo"
L["Disable if you dont want the full Garrison Commander Header."] = "Desactívalo si no quieres el encabezado completo de Garrison Commander."
L["Disables automatic population of mission page screen. You can also press control while clicking to disable it for a single mission"] = "Desactiva el llenado automático de la pantalla de misión. También puedes pulsar Control al hacer clic para desactivarlo en una misión"
L["Disabling this will give you the interface from 1.1.8, given or taken. Need to reload interface"] = "Desactivar esto te devolverá la interfaz clásica de la versión 1.1.8. Requiere recargar la interfaz (/reload)"
L["Do not show follower icon on plots"] = "No mostrar el icono del seguidor en los retratos"
L["Duration Time"] = "Duración"
L["Enhance tooltip"] = "Mejorar tooltip"
L["Environment Preference"] = "Preferencia de entorno"
L["Epic followers are NOT sent alone on xp only missions"] = "Seguidores épicos NO van solos a misiones de XP"
L["Expiration Time"] = "Tiempo de caducidad"
L["Follower"] = "Seguidor"
L["Follower equipment set or upgrade"] = "Conjunto o mejora de equipo de seguidor"
L["Follower experience"] = "Experiencia de seguidor"
L["Follower set minimum upgrade"] = "Mejora mín. conjunto"
L["Follower Training"] = "Entrenamiento de seguidor"
L["Followers status "] = "Estado de los seguidores "
L["Garrison Appearance"] = "Apariencia de la Ciudadela"
L["Garrison Comander Quick Mission Completion"] = "Completar Misiones Rápidamente de Garrison Commander"
L["Garrison Commander Mission Control"] = "Control de Misiones de Garrison Commander"
L["Global approx. xp reward"] = "Recompensa global aprox. de XP"
L["Global success chance"] = "Probabilidad de éxito global"
L["Gold incremented!"] = "¡Oro aumentado!"
L["Hide followers"] = "Ocultar seguidores"
L["If checked, clicking an upgrade icon will consume the item and upgrade the follower, |cFFFF0000NO QUESTION ASKED|r"] = "Si está activado, hacer clic en un icono de mejora consumirá el objeto y mejorará al seguidor |cFFFF0000SIN PEDIR CONFIRMACIÓN|r"
L["IF checked, shows armors on the left and weapons on the right "] = "Si está activado, muestra las armaduras a la izquierda y las armas a la derecha "
L["If you continue, you will lose them"] = "Si continúas, las perderás"
L["IF you have a Salvage Yard you probably dont want to have this one checked"] = "Si tienes Desguace (Salvage Yard) probablemente no querrás activar esto"
L["Ignore \"maxed\""] = "Ignorar maximizados"
L["Ignore epic for xp missions."] = "Ignorar épicos en XP"
L["Use epics to fill XP missions"] = "Rellenar XP con épicos"
L["If an XP mission lacks non-epic followers to fill all slots, use epic followers for remaining slots"] = "Si hay al menos 1 seguidor no épico en la misión, rellena los huecos restantes con épicos para asegurar el éxito."
L["Ignore resource missions (>6000)"] = "Ignorar recursos (>6k)"
L["Ignore resource missions if you already have more than 6000 resources"] = "Ignora las misiones de recursos si ya tienes más de 6000 recursos en tu haber"
L["Ignore for all missions"] = "Ignorar para todas las misiones"
L["Ignore for this mission"] = "Ignorar para esta misión"
L["Ignore rare missions"] = "Ignorar raras"
L["Increased Rewards"] = "Recompensas Aumentadas"
L["Item minimum level"] = "Nivel mín. objeto"
L["Item Tokens"] = "Fichas de objeto"
L["Left Click to see available missions"] = "Clic izquierdo para ver misiones disponibles"
L["Legendary Items"] = "Objetos Legendarios"
L["Level 100 epic followers are not used for xp only missions."] = "Épicos de nivel 100/110 no van a misiones de XP."
L["Makes main mission panel movable"] = "Permite mover el panel principal de misiones"
L["Makes shipyard panel movable"] = "Permite mover el panel del astillero"
L["Maximize result"] = "Maximizar resultado"
L["Maximum mission duration."] = "Duración máxima de misión."
L["Minimum chance"] = "Probabilidad mínima"
L["Minimum mission duration."] = "Duración mínima de misión."
L["Minimum needed chance"] = "Probabilidad mínima necesaria"
L["Minimum requested level for equipment rewards"] = "Nivel mínimo solicitado para recompensas de equipo"
L["Minimum requested upgrade for followers set (Enhancements are always included)"] = "Mejora mínima solicitada para el conjunto de seguidores (Siempre se incluyen mejoras)"
L["Minimun chance success under which ignore missions"] = "Probabilidad de éxito mínima por debajo de la cual se ignoran misiones"
L["Minumum needed chance"] = "Probabilidad mínima requerida"
L["Mission Control"] = "Control de Misiones"
L["Mission Duration"] = "Duración de misión"
L["Mission shown"] = "Misiones mostradas"
L["Mission shown for follower"] = "Misiones mostradas para el seguidor"
L["Mission Success"] = "Éxito de misión"
L["Mission time reduced!"] = "¡Tiempo de misión reducido!"
L["Mission with lower success chance will be ignored"] = "Se ignorarán las misiones con menor probabilidad de éxito"
L["Missionlist"] = "Lista de misiones"
L["Must reload interface to apply"] = "Debes recargar la interfaz (/reload) para aplicar"
L["No confirmation"] = "Sin confirmación"
L["No follower gained xp"] = "Ningún seguidor ganó XP"
L["No mission prefill"] = "No rellenar misiones"
L["Not blacklisted"] = "No en lista negra"
L["Nothing to report"] = "Nada que informar"
L["Number of followers"] = "Número de seguidores"
L["Only first %1$d missions with over %2$d%% chance of success are shown"] = "Solo se muestran las primeras %1$d misiones con más de %2$d%% de probabilidad de éxito"
L["Only meaningful upgrades are shown"] = "Solo se muestran las mejoras relevantes"
L["Original concept and interface by %s"] = "Concepto original e interfaz por %s"
L["Original method"] = "Método original"
L["Original sort restores original sorting method, whatever it was (If you have another addon sorting mission, it should kick in again)"] = "El orden original restaura el método de ordenación predeterminado"
L["Other"] = "Otros"
L["Other rewards"] = "Otras recompensas"
L["Other settings"] = "Otras configuraciones"
L["Other useful followers"] = "Otros seguidores útiles"
L["Processing mission %d of %d"] = "Procesando misión %d de %d"
L["Profession"] = "Profesión"
L["Racial Preference"] = "Preferencia racial"
L["Rare missions will not be considered"] = "No se tendrán en cuenta las misiones raras"
L["Reagents"] = "Componentes"
L["Reputation Items"] = "Objetos de reputación"
L["Reward type"] = "Tipo de recompensa"
L["Right-Click to blacklist"] = "Clic derecho para mandar a la lista negra"
L["Right-Click to remove from blacklist"] = "Clic derecho para eliminar de la lista negra"
L["Rush orders"] = "Órdenes de finalización rápida"
L["Shipyard Appearance"] = "Apariencia del Astillero"
L["Show Garrison Commander menu"] = "Mostrar menú de Garrison Commander"
L["Show itemlevel"] = "Mostrar nivel de objeto"
L["Show upgrades"] = "Mostrar mejoras"
L["Show xp"] = "Mostrar XP"
L["Slayer"] = "Asesino"
L["Some follower"] = "Algún seguidor"
L["Sort missions by:"] = "Ordenar misiones por:"
L["Submit all your mission at once. No question asked."] = "Envía todas tus misiones a la vez sin pedir confirmación."
L["Success Chance"] = "Probabilidad de éxito"
L["Swap upgrades positions"] = "Intercambiar posiciones de mejoras"
L["Switch between Garrison Commander and Master Plan interface for missions"] = "Cambiar entre la interfaz de Garrison Commander y Master Plan"
L["Threat Counter"] = "Contador de amenazas"
L["To go: %d"] = "Faltan: %d"
L["Toggles Garrison Commander Menu Header on/off"] = "Muestra u oculta el encabezado del menú de Garrison Commander"
L["Toys and Mounts"] = "Juguetes y Monturas"
L["Unchecking this will allow you to set specific success chance for each reward type"] = "Desactivar esto te permitirá establecer probabilidades de éxito por cada tipo de recompensa"
L["Unlock Panel"] = "Desbloquear panel"
L["Upgrade %1$s to  %2$d itemlevel"] = "Mejorar %1$s al nivel de objeto %2$d"
L["Upgrading to |cff00ff00%d|r"] = "Mejorando a |cff00ff00%d|r"
L["Use big screen"] = "Usar pantalla grande"
L["Use GC Interface"] = "Usar interfaz GC"
L["Uses armor token"] = "Usa ficha de armadura"
L["Uses weapon token"] = "Usa ficha de arma"
L["When checked, show on each follower button missing xp to next level"] = "Si está activado, muestra en el botón de cada seguidor la XP que le falta para subir"
L["When checked, show on each follower button weapon and armor level for maxed followers"] = "Si está activado, muestra el nivel de arma y armadura en seguidores maximizados"
L["Xp incremented!"] = "¡XP incrementada!"
L["You are wasting |cffff0000%d|cffffd200 point(s)!!!"] = "¡¡¡Estás desperdiciando |cffff0000%d|cffffd200 punto(s)!!!"
L["You can also send mission one by one clicking on each button."] = "También puedes enviar misiones una a una haciendo clic en cada botón."
L["You can open the menu clicking on the icon in top right corner"] = "Puedes abrir el menú haciendo clic en el icono de la esquina superior derecha"
L["You have ignored followers"] = "Tienes seguidores ignorados"
L["You never performed this mission"] = "Nunca has realizado esta misión"
L["You performed this mission %d times with a win ratio of"] = "Has realizado esta misión %d veces con un porcentaje de victoria de"
L["Minimum XP missions level"] = "Nivel mín. misiones XP"
L["Ignore XP missions under this level"] = "Ignora las misiones de XP por debajo de este nivel"
L["Minimum Gold Value"] = "Valor mín. de oro"
L["Gold missions wich returns less than this amount are ignored"] = "Se ignorarán las misiones de oro que den menos de esta cantidad"
L["Auto Logout"] = "Desconexión auto."
L["Automatically logout after sending missions"] = "Desconectar del personaje al terminar de enviar misiones"
L["No tooltips"] = "Sin tooltips"
L["Totally removes mission tooltips"] = "Oculta por completo las descripciones emergentes (tooltips) de las misiones"
