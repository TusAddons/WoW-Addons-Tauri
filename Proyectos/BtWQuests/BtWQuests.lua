...
function BtWQuests_GuessExpansion()
	...
	local minDiff = MAX_PLAYER_LEVEL_TABLE[LE_EXPANSION_LEVEL_CURRENT] or 110;
    ...
    print("[BtWQuests] Guessed expansion ID:", expansionId, "Expansions table length:", #BtWQuests_Expansions)
	return expansionId;
end
